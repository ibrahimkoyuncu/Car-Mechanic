...
<resources xmlns:ns1="http://schemas.android.com/tools">
    ...
    <color name="banner_line">#E0E0E0</color>
    ...
    <color name="field_view_stars_item">#EFC536</color>
    ...
    <color name="usa_accent">#00A5C9</color>
    <color name="usa_accented_text">#FFFFFF</color>
    <color name="usa_background">#FFFFFF</color>
    <color name="usa_error_color">#F4606E</color>
    <color name="usa_text">#59636B</color>
    <color name="usa_title">#41474C</color>
    <color name="usa_underlay">#66000000</color>
    ...
    <declare-styleable name="MaterialSpinner"><attr format="integer" name="ms_baseColor"/><attr format="integer" name="ms_highlightColor"/><attr format="integer" name="ms_errorColor"/><attr format="string" name="ms_error"/><attr format="string" name="ms_hint"/><attr format="color" name="ms_hintColor"/><attr format="string" name="ms_floatingLabelText"/><attr format="color" name="ms_floatingLabelColor"/><attr format="boolean" name="ms_multiline"/><attr format="integer" name="ms_nbErrorLines"/><attr format="string" name="ms_typeface"/><attr format="boolean" name="ms_alignLabels"/><attr format="dimension" name="ms_thickness"/><attr format="dimension" name="ms_thickness_error"/><attr format="dimension" name="ms_arrowSize"/><attr format="color" name="ms_arrowColor"/><attr format="boolean" name="ms_enableFloatingLabel"/><attr format="boolean" name="ms_enableErrorLabel"/><attr format="boolean" name="ms_isRtl"/></declare-styleable>
    ...
    <dimen name="banner_bottom_padding">16dp</dimen>
    <dimen name="banner_line_height">5dp</dimen>
    <dimen name="banner_margin_right">24dp</dimen>
    ...
    <dimen name="error_label_spacing">12dp</dimen>
    <dimen name="field_error_margin">4dp</dimen>
    <dimen name="field_margin">8dp</dimen>
    <dimen name="field_title_margin">20dp</dimen>
    <dimen name="field_title_margin_field_view">10dp</dimen>
    <dimen name="field_title_margin_paragraph_bottom">4dp</dimen>
    <dimen name="field_title_padding">12dp</dimen>
    <dimen name="field_view_checkbox_icon_margin">7dp</dimen>
    <dimen name="field_view_email_margin">4dp</dimen>
    <dimen name="field_view_mood_icon_margin">8dp</dimen>
    <dimen name="field_view_mood_margin">8dp</dimen>
    <dimen name="field_view_radio_icon_margin">6dp</dimen>
    <dimen name="field_view_screenshot_icon_distance">26dp</dimen>
    <dimen name="field_view_screenshot_icon_margin">6dp</dimen>
    <dimen name="field_view_screenshot_icon_size">40dp</dimen>
    <dimen name="field_view_slider_container_padding">10dp</dimen>
    <dimen name="field_view_slider_seekbar_left_label_left_margin">15dp</dimen>
    <dimen name="field_view_slider_seekbar_right_label_right_margin">15dp</dimen>
    <dimen name="field_view_slider_seekbar_underscore_height">2dp</dimen>
    <dimen name="field_view_slider_seekbar_underscore_top_margin">2dp</dimen>
    <dimen name="field_view_slider_seekbar_underscore_width">20dp</dimen>
    <dimen name="floating_label_bottom_spacing">8dp</dimen>
    <dimen name="floating_label_inside_spacing">12dp</dimen>
    <dimen name="floating_label_top_spacing">4dp</dimen>
    ...
    <dimen name="min_content_height">20dp</dimen>
    <dimen name="min_height_scroll_view">20dp</dimen>
    ...
    <dimen name="page_footer_padding">12dp</dimen>
    <dimen name="page_last_buttons_topMargin">30dp</dimen>
    <dimen name="page_navigation_button_cancel_rightMargin">16dp</dimen>
    <dimen name="page_navigation_button_margin">8dp</dimen>
    <dimen name="page_top_label_margin">10dp</dimen>
    <dimen name="right_left_spinner_padding">8dp</dimen>
    <dimen name="thankyou_page_textParagraph_size">20sp</dimen>
    <dimen name="thankyou_page_text_marginTop">16dp</dimen>
    <dimen name="thankyou_page_text_size">22sp</dimen>
    ...
    <dimen name="underline_bottom_spacing">4dp</dimen>
    <dimen name="underline_top_spacing">8dp</dimen>
    ...
    <item name="moodComponent" type="id"/>
    <item name="page_button_cancel" type="id"/>
    <item name="page_button_proceed" type="id"/>
    <item name="page_last_button_cancel" type="id"/>
    <item name="page_last_button_more_feedback" type="id"/>
    <item name="page_last_button_playstore" type="id"/>
    ...
    <integer name="anim_enter_bouncing_duration">500</integer>
    <integer name="anim_enter_bouncing_start_offset">900</integer>
    <integer name="anim_enter_translate_duration">1200</integer>
    <integer name="anim_exit_translate_duration">700</integer>
    ...
    <string name="playstore_prefix">market://details?id=%s</string>
